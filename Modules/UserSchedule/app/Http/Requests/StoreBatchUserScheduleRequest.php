...
namespace Modules\UserSchedule\Http\Requests;
...
class StoreBatchUserScheduleRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'schedules.*.start_time'       => ['nullable', 'required_if:schedules.*.type,'.UserScheduleRecordType::WORKING_DAY->value, 'date_format:H:i'],
            'schedules.*.end_time'         => ['nullable', 'required_if:schedules.*.type,'.UserScheduleRecordType::WORKING_DAY->value, 'date_format:H:i', 'after:schedules.*.start_time'],
    ...
    public function messages(): array
    {
        return [
            ...
            'schedules.*.start_time.required_if'   => 'Start time is required.',
            'schedules.*.start_time.date_format'   => 'Start time must be in HH:MM format.',
            'schedules.*.end_time.required_if'     => 'End time is required.',
