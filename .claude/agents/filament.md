...
namespace App\Filament\Resources\MentorProgram;

use App\Models\MentorProgram;
use Filament\Resources\Resource;

class MentorProgramResource extends Resource
{
    protected static ?string $model = MentorProgram::class;

    protected static ?string $navigationIcon = Heroicon::AcademicCap;

    public static function form(Form $form): Form
    {
        return $form->schema(MentorProgramForm::schema());
    }

    public static function table(Table $table): Table
    {
        return $table->configure(MentorProgramsTable::configure());
    }

    public static function getPages(): array
    {
        return [
            'index' => ListMentorPrograms::route('/'),
            'create' => CreateMentorProgram::route('/create'),
            'edit' => EditMentorProgram::route('/{record}/edit'),
        ];
    }
}
```
