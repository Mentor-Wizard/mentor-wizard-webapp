...
describe('Google Calendar Integration', function (): void {
    beforeEach(function (): void {
        if (! env('TEST_GOOGLE_ACCESS_TOKEN')) {
        ...
        $this->service = app(GoogleExternalCalendarService::class);
    ...
    it('fetches nothing when no events exist in the requested range', function (): void {
        ...
        $to   = Carbon::create(2000, 1, 1, 1, 0, 0, 'UTC');
    ...
    it('fetches multiple events within a range', function (): void {
        $base = Carbon::create(2026, 7, 20, 9, 0, 0, 'UTC');
    ...
    it('returns FetchedCalendarEventData instances', function (): void {
        ...
        expect($match)->toBeInstanceOf(FetchedCalendarEventData::class)
            ->and($match->startUtc)->toBeInstanceOf(Carbon::class)
            ->and($match->endUtc)->toBeInstanceOf(Carbon::class);
    });
    ...
    it('correctly roundtrips an event at UTC midnight', function (): void {
        $start = Carbon::create(2026, 9, 1, 0, 0, 0, 'UTC'); // midnight UTC
    ...
    it('correctly roundtrips an event during EU spring-forward (2026-03-29)', function (): void {
        ...
        $start = Carbon::create(2026, 3, 29, 0, 30, 0, 'UTC');
        $end   = Carbon::create(2026, 3, 29, 1, 30, 0, 'UTC');
    ...
    it('correctly handles a cross-midnight UTC event', function (): void {
        ...
        $end   = Carbon::create(2026, 6, 16, 1, 0, 0, 'UTC'); // next day
    ...
    it('does not include events outside the requested range', function (): void {
        ...
        $outOfRange = Carbon::create(2026, 10, 5, 20, 0, 0, 'UTC'); // outside window
