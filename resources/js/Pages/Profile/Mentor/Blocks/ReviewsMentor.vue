...
const totalCount =
  props.statistic.star_5
  + props.statistic.star_4
  + props.statistic.star_3
  + props.statistic.star_2
  + props.statistic.star_1;
const ratingTotal = (
...
<template>
  <div class="mt-6">
    <div class="flex items-center justify-between">
      <div>
        <h2 class="mb-4 text-lg font-bold">Reviews & Testimonials</h2>
      </div>
      <div class="flex">
        <StarIcon
          ...
          :key="rating"
          :class="[
            ratingTotal > rating ? 'text-yellow-400' : 'text-gray-200',
            'size-5 shrink-0',
          ]"
          aria-hidden="true"
        />
  ...
  <div v-if="model.length" class="mt-4 lg:col-span-12">
    <div v-for="review in model" :key="review.id" class="w-full pb-6">
      <div class="flex gap-3">
        <img
          :src="review.menti.avatar"
          :alt="review.menti.username"
