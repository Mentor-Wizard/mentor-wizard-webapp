                ...
                <div class="flex flex-1 items-center justify-center px-2 lg:ml-6 lg:justify-end">
                    <div class="grid w-full max-w-lg grid-cols-1 lg:max-w-xs">
                        ...
                        <input id="search" type="search" name="search"
                               class="col-start-1 row-start-1 block w-full rounded-md border-0 bg-white py-1.5 pr-3 pl-10 text-base text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6"
                               placeholder="Search"/>
                        <MagnifyingGlassIcon
        ...
        <DisclosurePanel class="lg:hidden">
            ...
            <div v-if="isLoggedIn" class="bg-white border-t border-gray-200 pt-4 pb-3">
                ...
                <div class="mt-3 space-y-1">
                    <DisclosureButton v-for="userNavigation in userNavigations" :key="userNavigation.name"
