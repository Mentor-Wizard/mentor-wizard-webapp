    ...
    <form @submit.prevent="updatePassword" class="md:col-span-2">
      <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:max-w-xl sm:grid-cols-6">
        <div class="col-span-full">
          ...
          <div class="mt-2">
            <TextInput id="current_password" ref="currentPasswordInput" type="password" autocomplete="current_password" v-model="form.current_password" required/>
          </div>
        ...
        <div class="col-span-full">
          ...
          <div class="mt-2">
            <TextInput id="password" type="password" ref="passwordInput" autocomplete="password" v-model="form.password" required/>
          </div>
        ...
        <div class="col-span-full">
          ...
          <div class="mt-2">
            <TextInput id="password_confirmation" type="password" autocomplete="password_confirmation" v-model="form.password_confirmation" required/>
          </div>
