...
<template>
    <div v-if="data.links.length > 3" class="flex items-center justify-between border-t border-gray-200 px-4 sm:px-0 mt-6" >
    ...
    <div class="flex justify-between md:hidden mt-4 border-t border-gray-200 px-4 pt-4">
        <Link
            v-if="data.prev_page_url"
            :href="data.prev_page_url"
            preserve-scroll
