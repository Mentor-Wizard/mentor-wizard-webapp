...
| Language | JavaScript (majority) + TypeScript (Calendar, Notifications — migrating) |
| State | Pinia 3 |
| Routing | Ziggy |
...
│   ├── Chat/                 # Chat pages
│   ├── MentorProgram/        # Mentor program pages
│   ├── Profile/              # User profile + tabs
│   ├── UserSchedule/         # Schedule pages
