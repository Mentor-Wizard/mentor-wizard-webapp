...
> Reference for: Test Master Load when: TDD methodology, test-first development,
> red-green-refactor
...
> "You shall not write any production code unless it is to make a failing test
> pass."
...
> "Production code exists → A test exists that failed first. Otherwise → It's
> not TDD."
