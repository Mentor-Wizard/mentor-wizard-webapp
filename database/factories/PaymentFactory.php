...
class PaymentFactory extends Factory
{
    ...
    public function definition(): array
    {
        return [
            ...
            'currency'           => fake()->randomElement(array_column(CurrencyEnum::cases(), 'value')),
            'transaction_status' => fake()->randomElement(array_column(PaymentStatusEnum::cases(), 'value')),
            'payment_type'       => fake()->randomElement(array_column(PaymentTypeEnum::cases(), 'value')),
            'reason'             => fake()->optional()->sentence(),
            'reason_code'        => fake()->optional()->numerify('####'),
            'payment_system'     => fake()->randomElement(array_column(PaymentGatewayEnum::cases(), 'value')),
