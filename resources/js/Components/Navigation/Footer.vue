                ...
                <div class="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
                    <div class="md:grid md:grid-cols-2 md:gap-8">
                        <div>
                            ...
                            <ul role="list" class="mt-6 space-y-4">
                                <li v-for="item in footer.navigation.solutions" :key="item.name">
                                    <a :href="item.href"
                                       class="text-sm/6 text-gray-600 hover:text-gray-900">{{ item.name }}</a>
                                </li>
                            </ul>
                        </div>
                        <div class="mt-10 md:mt-0">
                            ...
                            <ul role="list" class="mt-6 space-y-4">
                                <li v-for="item in footer.navigation.support" :key="item.name">
                                    <a :href="item.href"
                                       class="text-sm/6 text-gray-600 hover:text-gray-900">{{ item.name }}</a>
                                </li>
                            </ul>
                    ...
                    <div class="md:grid md:grid-cols-2 md:gap-8">
                        <div>
                            ...
                            <ul role="list" class="mt-6 space-y-4">
                                <li v-for="item in footer.navigation.company" :key="item.name">
                                    <a :href="item.href"
                                       class="text-sm/6 text-gray-600 hover:text-gray-900">{{ item.name }}</a>
                                </li>
                            </ul>
                        ...
                        <div class="mt-10 md:mt-0">
                            ...
                            <ul role="list" class="mt-6 space-y-4">
                                <li v-for="item in footer.navigation.legal" :key="item.name">
                                    <a :href="item.href"
                                       class="text-sm/6 text-gray-600 hover:text-gray-900">{{ item.name }}</a>
                                </li>
                            </ul>
