...
description:
  ...
  quality assurance.\n\nУкраїнською: Перевір код, рев'ю коду, якість коду,
  знайди баги, вразливості безпеки, стандарти кодування, рефакторинг, код смел,
  статичний аналіз, продуктивність коду, надійність."
metadata:
  model: opus
risk: unknown
source: community
