...
return [
    ...
    'paths' => [
        ...
        */
        'generator' => [
            ...
            // app/Http/
            // Project does not use controllers — routing goes through invokable
            // Actions (lorisleiva/laravel-actions), confirmed BA §13.1.
            ...
            // resource/
            // Inertia-only project — Blade views are not used for business pages,
            // and Vue ownership stays outside Modules/* through Phase 0-8 (plan §3, Q2).
    ...
    */
    'composer' => [
        // Project's own vendor namespace (matches root composer.json "name"), not the
        // laravel-modules package author — never "nwidart".
        'vendor' => env('MODULE_VENDOR', 'mentor-wizard'),
        // No default author identity is stamped into module composer.json files;
        // stubs/module/composer.stub omits the "authors" block entirely.
        'author' => [
